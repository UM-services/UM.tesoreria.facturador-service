...
COPY --from=build /app/target/um.tesoreria.facturador-service.jar ./um.tesoreria.facturador-service.jar
...
ENTRYPOINT ["java", "-jar", "um.tesoreria.facturador-service.jar"]
